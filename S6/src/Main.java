...
class ProgramFacturi {
    ...
    static void generareRaport(String caleFisier, List<Factura>facturi){
        class DateClient{
            ...
            public DateClient(String clienti) {
        ...
        for(var factura : facturi){
            ...
            dateClient.numarFacturi++;
            dateClient.total+=factura.getValoare();
        }
...
////        System.out.println(clienti);
        ...
        Collections.sort(dateClienti,(c1,c2)->Double.compare(c2.total,c1.total));
        ...
        try(var fisier = new PrintWriter(caleFisier)) {
            ...
            System.err.println("Nu putem scrie in fisier " + caleFisier+ "- "+e.getMessage());
        }



        var test=new DateClient("testescu srl");
        test.numarFacturi+=3;
        test.total=121212.12;
